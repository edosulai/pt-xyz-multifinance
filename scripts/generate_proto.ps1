...
$cmd = "protoc",
       ...
       "-I","third_party",
       "--go_out=.",
       "--go_opt=module=github.com/edosulai/pt-xyz-multifinance",
       "--go-grpc_out=.",
       "--go-grpc_opt=module=github.com/edosulai/pt-xyz-multifinance",
       "--grpc-gateway_out=.",
       "--grpc-gateway_opt=module=github.com/edosulai/pt-xyz-multifinance",
